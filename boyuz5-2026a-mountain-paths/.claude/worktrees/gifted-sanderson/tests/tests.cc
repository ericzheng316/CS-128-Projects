...
TEST_CASE("ed_too_little", "[ed_too_little]") {
  const std::string kTestFile =
      "example-data/ex_input_data/all-tie-row1-2w-3h.dat";
...
TEST_CASE("Example Navigation Test: Go forward.", "[forward-2-3]") {
  ...
  // We want to analyze the program's behavior on the path starting from Row1,
...
//   const std::string kTestFile =
//   "./example-data/ex_input_data/prompt_5w_2h.dat"; const std::string
//   kGroundTruth =
